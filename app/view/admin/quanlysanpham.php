...
<main>
    <div class="toolbar">
        <div class="left">
            <div class="add-button">
                ...
                <p><a href="themsanpham" class="a" style="color: white" ;>Thêm sản phẩm</a></p>
            </div>
    ...
    <div class="list-product">
        <table>
            ...
            <?php foreach($products = $sps->ql_sp() as $product) {extract($product); ?>
            <tr>
                ...
                <?php $category = $dm->get_category_by_product_id($Id);?>
                <!-- <?php var_dump($category)?> -->
                <td class="product-category"><?=$category ? $category[0]['Name'] : "Chưa phân loại"?></td>
                <td class="product-action">
                    <div class="edit-button">
                        <a href="suasanpham?id=<?=$Id?>" class="a">
                    ...
                    <a class="remove-button" href="del_info?id=<?=$Id?>">
