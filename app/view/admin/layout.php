...
<body>
    <?php
        $nd= new App\model\user();
        $admin = $nd->get_user_by_id($_SESSION['LOGGED_IN_ADMIN_ID']);
    ?>
    <header>
        <div class="logo">
            <img src="../../public/image/logo-white.png" alt="">
        </div>
        <div class="left">
        ...
        <div class="right">
            ...
            <a href="taikhoan">
                <img class="avt"
                    src="../../public/image/user/<?=$admin[0]['Avatar'] ? $admin[0]['Avatar'] : 'default.png'?>" alt="">
            </a>
    ...
    <div class="sidebar">
        <ul>
            <a data-name="thongke" href="thongke">
            ...
            <a data-name="quanlysanpham" href="quanlysanpham">
                <div class="border"></div>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <a data-name="quanlydanhmuc" href="quanlydanhmuc">
                <div class="border"></div>
            ...
            <a data-name="quanlynguoidung" href="quanlynguoidung">
                <div class="border"></div>
            ...
            <a data-name="quanlydonhang" href="quanlydonhang">
                <div class="border"></div>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <a data-name="quanlydanhgia" href="quanlydanhgia">
                <div class="border"></div>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
