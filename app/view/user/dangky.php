...
<main>
    <div>
        <img src="../../public/image/login-image.png" alt>
        <div>
            <form action="" method="post" id="form" onsubmit="return check_form();">
                ...
                <a href="/dangnhap" class="inline-content">
