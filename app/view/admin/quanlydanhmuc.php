...
.list-category table tr:first-child td,
.list-category table tr td:first-child,
.list-category table tr td:last-child {
    text-align: center;
}
    ...
    <div class="list-category">
        <table>
            ...
            <tr>
                ...
                <td class="category-image"><img src="../../public/image/<?=$Image?>" alt=""></td>
                <td class="category-name"><?=$Name?></td>
                <td class="category-product-count">
                    <?php 
                    $count = 0;
                    $count = $dm->get_product_count_by_category_id($Id); ?>
