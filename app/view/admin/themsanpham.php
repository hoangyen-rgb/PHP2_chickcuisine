...
$dm = new App\model\danhmuc();
?>
<main>
    <form method="post" action="/themsp_info" enctype="multipart/form-data">
        <div class="toolbar">
            <div class="left">
        ...
        <div class="container">
            <div class="left">
                ...
                <textarea required name="product_description" id="product-description"
                    style="grid-column: 1 / 4; grid-row: 4 / 5;"></textarea>
                <label for="product-price" style="grid-column: 1 / 2; grid-row: 5 / 6;">Giá bán</label>
                <input required type="number" name="product_price" id="product-price" min="1000" step="000"
                ...
                <select name="product_category" id="product-category" style="grid-column: 2 / 3; grid-row: 2 / 3;">
                    ...
                    foreach ($categories as $category) {extract($category); ?>
            ...
            <div class="right">
                ...
                <input required id="file-upload" type="file" name="product_image" style="display: none;"
                    accept="image/*">
            </div>
        </div>
    </form>
