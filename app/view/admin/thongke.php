...
<main>
    <div class="statistics">
        <div class="revenue">
            <div class="top">
                ...
                <p class="interval" onclick='ApplyFilters(filter("time_frame", "previous"))'>Chuyển sang
                    <?=$interval_name?> trước</p>
                <?php } else { ?>
                <p class="interval" onclick='ApplyFilters(filter("time_frame", "current"))'>Chuyển sang
                    <?=$interval_name?> hiện tại</p>
                <?php } ?>
                <div class="legends">
                    <div class="legend">
            ...
            <div class="left">
                ...
                <div class="buttons">
                    <a <?php if ($interval == "month") { ?>class="selected" <?php } ?>
                        href="thongke?interval=month">Theo tháng</a>
                    <a <?php if ($interval == "week") { ?>class="selected" <?php } ?> href="thongke?interval=week">Theo
                        tuần</a>
                    <a <?php if ($interval == "day") { ?>class="selected" <?php } ?> href="thongke?interval=day">Theo
                        ngày</a>
                </div>
            </div>
            <div class="right">
    ...
    <div class="statistics-total">
        <div class="product">
            ...
            <p class="count"><?=$tk->get_products_count()?></p>
        ...
        <div class="category">
            ...
            <p class="count"><?=$tk->get_categories_count()?></p>
        ...
        <div class="user">
            ...
            <p class="count"><?=$tk->get_users_count()?></p>
        ...
        <div class="invoice">
            ...
            <p class="count"><?=$tk->get_orders_count()?></p>
        ...
        <div class="feedback">
            ...
            <p class="count"><?=$tk->get_comments_count()?></p>
...
function drawRevenueChart() {
    var data = google.visualization.arrayToDataTable([
        ['Kỳ', 'Nhập vào', 'Bán ra'],
        <?php foreach($revenue_statistic as $row) {extract($row); ?>['T<?=$Period?>', <?=$TotalCost?>,
            <?=$TotalPrice?>],
        <?php } ?>
    ]);
    ...
    var options = {
        ...
        vAxis: {
            minValue: 0,
            maxValue: <?=$max_revenue_statistic_value?>
        }
    };
    ...
    google.visualization.events.addListener(chart, 'ready', function() {
        var observer = new MutationObserver(function() {
            container.getElementsByTagName('svg')[0].setAttribute('xmlns',
...
function ApplyFilters(filters) {
    ...
    var url = "thongke?" + filter_array.join("&");

    window.location.href = url;
}

// Sử dụng hàm ApplyFilters
var filter = [
    new Filter("interval", "month")
